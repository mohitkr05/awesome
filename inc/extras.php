 ...
 * @since awesome 1.0
 */
function awesome_enhanced_image_navigation( $url, $id ) {
...
add_filter( 'attachment_link', 'awesome_enhanced_image_navigation', 10, 2 );
...
function awesome_wp_title( $title, $sep ) {
	...
	if ( $paged >= 2 || $page >= 2 )
		$title .= " $sep " . sprintf( __( 'Page %s', 'awesome' ), max( $paged, $page ) );
